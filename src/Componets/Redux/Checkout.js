...
const Checkout = () => {
    ...
    return (
        <>
            ...
            <h5 className='text-center'>Choose yours Adress</h5>
            <hr />
            <br />
            <div className='text-center check'>
                <br />
                <input type="radio" name="hello" /> <p>Indore , Mp</p>
            </div>
            <div className='text-center'>
                <input type="radio" name="hello" /> <p>Gorkhapur , up</p>
            </div>
            <div className='text-center'>
                <input type="radio" name="hello" /> <p>Rajnagar , Mp</p>
            </div>
            <div className='text-center'>
                <NavLink to="/" className="shop_btn text-center" >Make Payment of Items {data.length}</NavLink></div>
